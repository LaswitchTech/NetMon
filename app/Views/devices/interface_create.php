<?php
/**
 * Add Interface — content fragment.
 *
 * Variables:
...
<div class="mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb small mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">Add Interface</li>
        </ol>
    </nav>
    <h1 class="h4 fw-semibold mb-1">Add Interface</h1>
    <p class="text-muted mb-0 small">Add a network interface to <?= htmlspecialchars($device['name']) ?>.</p>
</div>

<div class="card" style="max-width: 540px;">
    <div class="card-body p-4">
        <form method="post" action="/devices/<?= (int) $device['id'] ?>/interfaces" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="text"
                       ...
                       value="<?= htmlspecialchars($old['mac'] ?? '') ?>"
            ...
            <div class="mb-3">
                <div class="form-check">
                    <input class="form-check-input<?= isset($errors['is_management']) ? ' is-invalid' : '' ?>"
                           ...
                           <?= !empty($old['isManagement']) ? 'checked' : '' ?>>
